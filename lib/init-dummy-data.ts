  ...
  const dummyItems = [
    {
      ...
      type: 'Shirt',
      description: 'High-quality moisture-wicking fabric perfect for intense workouts. Breathable material keeps you cool during any activity.',
      coverImage: 'https://images.unsplash.com/photo-1581655353564-df123a1eb820?w=800&auto=format&fit=crop&q=80',
      additionalImages: [
    ...
    },
    {
      ...
      type: 'Shoes',
      description: 'Engineered for maximum comfort and performance. Enhanced cushioning for impact absorption and responsive energy return.',
    ...
    {
      id: '103',
      name: 'Athletic Pants Flex',
      type: 'Pant',
      description: 'Stretchy, lightweight fabric that moves with you. Perfect for yoga, running, or everyday casual wear.',
      coverImage: 'https://images.unsplash.com/photo-1552902865-b72c031ac5ea?w=800&auto=format&fit=crop&q=80',
      additionalImages: [
    ...
    },
    {
      ...
      coverImage: 'https://images.unsplash.com/photo-1518908336710-4e1cf821d3d1?w=800&auto=format&fit=crop&q=80',
      additionalImages: [
